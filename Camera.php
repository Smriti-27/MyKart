    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                $result= mysqli_query($con,"select * from product_master where P_type='Camera'");
                if(mysqli_num_rows($result)>0)
                {
                    ...
                    while($row= mysqli_fetch_array($result))
                    {
                        ...
                        echo"<div class='box'>";
                            echo "<div class='row'><div class='col-sm-12'><a href='Cameradesc.php?pid=$row[0]'><img src='$row[4]'></a></div></div>";
